...
export default function SecondPriceTable() {
  return (
 <div className=" bg-gray-100 p-6">
      <div className="w-full max-w-full flex flex-col gap-7">
        <div className='bg-[#0BCFE6] py-3 flex justify-center text-center text-4xl text-white font-tilt-wrap'>
          AOA
        </div>
          ...
          <table className="w-full table-fixed text-sm">
            ...
            <tbody>
              <tr className="bg-gray-200">
                ...
                <td className="py-3 text-center border-r  font-inter border-t border-[#ccc]">$600</td>
              </tr>
              ...
              <tr className="bg-white">
                ...
                <td className="py-3 text-center border-r  font-inter border-t border-[#ccc]">$650</td>
              </tr>
              ...
              <tr className="bg-gray-200">
                ...
                <td className="py-3 text-center border-r  font-inter border-t border-b border-[#ccc]">$725</td>
              </tr>
            </tbody>
          </table>
        </div>
